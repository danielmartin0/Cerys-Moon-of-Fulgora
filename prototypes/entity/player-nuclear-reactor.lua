...
reactor.lower_layer_picture = {
	filename = "__Cerys-Moon-of-Fulgora__/graphics/entity/player-nuclear-reactor/reactor-pipes.png",
	width = 448,
	height = 442,
	scale = 0.5,
...
reactor.heat_lower_layer_picture = apply_heat_pipe_glow({
	filename = "__Cerys-Moon-of-Fulgora__/graphics/entity/player-nuclear-reactor/reactor-pipes-heated.png",
	width = 448,
	height = 442,
	scale = 0.5,
	shift = util.by_pixel(-1, -5),
...
-- I reduced them to 0.5 to make them the same size as normal pipes
...
for i = 0, 15 do
	...
	reactor.connection_patches_connected[i + 1] = {
		filename = "__Cerys-Moon-of-Fulgora__/graphics/entity/player-nuclear-reactor/reactor-connect-patches-4x4.png",
		width = 64,
		height = 64,
		x = x,
