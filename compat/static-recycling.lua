data.raw['recipe']['uranium-238-recycling']['surface_conditions'] = { { property = "magnetic-field", max = 119 } }
...
local RECYCLE_TO_ITSELF = { 'solid-fuel', 'steel-plate', 'copper-plate', 'iron-plate', 'stone-brick', 'plastic-bar',
	'holmium-plate', 'uranium-235' }

for i = 1, #RECYCLE_TO_ITSELF do
	data.raw['recipe'][RECYCLE_TO_ITSELF[i] .. '-recycling']['ingredients'] = { { type = 'item', name = RECYCLE_TO_ITSELF[i], amount = 1 } }
