...
require("prototypes.entity.explosions-neutron")
require("prototypes.entity.explosions-nuke")
require("prototypes.entity.explosions-other")
...
require("prototypes.entity.radiative-heater")
